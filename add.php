<form id="main-form" class="vg-wrap vg-element vg-ninteen-of-twenty" method="post" action="<?=$this->adminPath . $this->action?>" enctype="multipart/form-data">
    ...
    <?php
        foreach($this->blocks as $class => $block) {
            ...
            if($class !== 'vg-content') echo '<div class="vg-wrap vg-element vg-full vg-box-shadow">';
                    ...
                    foreach($this->templateArr as $template => $items) {
                        ...
                        if(in_array($row, $items)) {
                            ...
                            if(!@include $_SERVER['DOCUMENT_ROOT'] . $this->formTemplates . $template . 'php') {
                                throw new \core\base\exceptions\RouteException('Not found ' . 
...
<div class="vg-wrap vg-element vg-img"><div class="vg-full vg-firm-background-color4 vg-box-shadow"><div class="vg-wrap vg-element vg-full vg-box-shadow img_container img_wrapper">
        ...
        <div class="vg-wrap vg-element vg-full vg-box-shadow">
            ...
            <div class="vg-element vg-full">
                <div class="vg-element vg-full vg-left" style="flex-wrap: wrap">
                    ...
                    <textarea name="content" class="vg-input vg-text vg-full vg-firm-color1" id="mce_editor_0" aria-hidden="true" style="display: none;">test</textarea>
                    <div role="application" class="tox tox-tinymce" aria-disabled="false" style="visibility: hidden; height: 400px;">
